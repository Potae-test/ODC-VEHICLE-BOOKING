...
const postRouteActions: Record<string, string> = {
  ...
  "/api/notifications/delete": "deleteNotification",
  "/api/notifications/delete-all": "deleteAllNotificationsForCurrentUser",
  ...
  "/api/bookings/complete-on-behalf": "completeBookingOnBehalf",
